...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run full-model calibration collection.")
    ...
    pipeline.run(stages=["collect"], model_key=args.model_key, run_dir=args.run_dir)
